    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      >
        <div className="px-4 pt-4 pb-2 flex flex-col gap-3">
          ...
          {/* Layout Expandido (Mobile ou Desktop Normal) */}
          ...
          {/* Layout Colapsado (Apenas Desktop) */}
            ...
            {navItems.map(({ label, icon: Icon, to }) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  {/* CSS para esconder texto apenas no Desktop Colapsado */}
        ...
        <div className="px-4 py-4 border-t border-gray-200">
          <button
            ...
            className={`flex cursor-pointer items-center px-3 py-2.5 rounded-md text-sm transition-all w-full text-gray-600 hover:bg-gray-50 hover:text-gray-900 gap-3 ${
              collapsed ? "md:justify-center" : ""
            }`}
          >
      ...
      <main className="flex-1 bg-gray-50 p-4 md:p-8 overflow-y-auto pt-20 md:pt-8 w-full">{children}</main>
    </div>
  );
}